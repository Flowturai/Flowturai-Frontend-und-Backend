...
const ShaderBackground: React.FC<{ className?: string }> = ({
  ...
  const fsSource = `
    ...
    const vec4 lineColor = vec4(0.145, 0.388, 0.922, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.016, 0.047, 0.102, 1.0);
      vec4 bgColor2 = vec4(0.025, 0.075, 0.200, 1.0);
