      ...
      fragmentShader: `
        ...
        void main() {
          ...
          for (float i = 0.0; i < 35.0; i++) {
            ...
            /* Aurora blues / cyans / periwinkles — matches #c6e2ff palette */
            vec4 auroraColors = vec4(
              0.05 + 0.15 * sin(i*0.2 + iTime*0.4),          // R – stay low
              0.25 + 0.35 * cos(i*0.3 + iTime*0.5),          // G – mid
              0.70 + 0.30 * sin(i*0.4 + iTime*0.3),          // B – dominant
              1.0
            );
